...
echo 'Calculating meanstd of dataset, saving result to' $DIR/meanstd.txt
python calc_meanstd.py -d $DIR > $DIR/meanstd.txt
...
python sample_dataset.py -d $DIR
...
python sample_dataset.py -d $ALPHANUM_DIR
